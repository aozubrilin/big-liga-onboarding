...
/* harmony import */ var _modules_preloader__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/preloader */ "./js/modules/preloader.js");
/* harmony import */ var _modules_changeIntroTablet__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/changeIntroTablet */ "./js/modules/changeIntroTablet.js");
...
Object(_modules_preloader__WEBPACK_IMPORTED_MODULE_2__["preloader"])();
Object(_modules_changeIntroTablet__WEBPACK_IMPORTED_MODULE_3__["changeIntroTablet"])();

/***/ }),

/***/ "./js/modules/changeIntroTablet.js":
/*!*****************************************!*\
  !*** ./js/modules/changeIntroTablet.js ***!
  \*****************************************/
/*! exports provided: changeIntroTablet */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "changeIntroTablet", function() { return changeIntroTablet; });
var changeIntroTablet = function changeIntroTablet() {
  var mainPage = document.querySelector(".page-main");
  var introRow = document.querySelector(".intro__row");
...
var preloader = function preloader() {
  ...
  var onPressEnter = function onPressEnter(evt) {
    if (evt.key === "Enter") {
      evt.preventDefault();
      load();
  ...
  var onClick = function onClick(evt) {
    ...
    if (el.classList && el.classList.contains("preloader__img") || el.classList.contains("preloader__logo")) {
      return;
    }
